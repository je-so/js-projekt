...
static int test_generic(void)
{
   ...
   // TEST cast_typeadapt
   TEST((typeadapt_t*)0        == cast_typeadapt((testadapt_t*)0, testadapt_t, testobject_t, double*)) ;
   TEST((typeadapt_t*)&testadp == cast_typeadapt(&testadp, testadapt_t, testobject_t, double*)) ;
...
static int test_typeadaptmember(void)
{
   ...
   nodeadp = (typeadapt_member_t) typeadapt_member_INIT(cast_typeadapt(&testadp, testadapt_t, testobject_t, double*), 0) ;
