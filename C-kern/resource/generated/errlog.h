...
struct p_FILE_FORMAT_MISSING_ENDOFLINE_ERRLOG { const char * filename; };
...
struct p_PARSEERROR_EXPECTCHAR_ERRLOG { size_t linenr; size_t colnr; const char * chr; };
void PARSEERROR_EXPECTCHAR_ERRLOG(struct logbuffer_t * logbuffer, void * _p);
struct p_PARSEERROR_EXPECTNEWLINE_ERRLOG { size_t linenr; size_t colnr; };
...
struct p_STATE_WRONG_SIGHANDLER_DEFINED_ERRLOG { const char * signame; };
void STATE_WRONG_SIGHANDLER_DEFINED_ERRLOG(struct logbuffer_t * logbuffer, void * _p);
struct p_TEST_INPARAM_FALSE_ERRLOG { const char * violated_condition; };
void TEST_INPARAM_FALSE_ERRLOG(struct logbuffer_t * logbuffer, void * _p);
struct p_TEST_INVARIANT_FALSE_ERRLOG { const char * violated_condition; };
void TEST_INVARIANT_FALSE_ERRLOG(struct logbuffer_t * logbuffer, void * _p);
struct p_TEST_OUTPARAM_FALSE_ERRLOG { const char * violated_condition; };
void TEST_OUTPARAM_FALSE_ERRLOG(struct logbuffer_t * logbuffer, void * _p);
struct p_TEST_STATE_FALSE_ERRLOG { const char * violated_condition; };
