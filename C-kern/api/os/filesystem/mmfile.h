 ...
 * mmfile_openmode_CREATE - Creates a new file with the given size and opens it with <mmopen_RDWR_SHARED>.
 *                          The file_offset must be set to 0.
...
enum mmfile_openmode_e {
   ...
   mmfile_openmode_CREATE       = 1,
   mmfile_openmode_RDWR_SHARED  = 2,
   mmfile_openmode_RDWR_PRIVATE = 3
} ;
 ...
 * If mode is mmfile_openmode_CREATE and the file exists an error is returned.
