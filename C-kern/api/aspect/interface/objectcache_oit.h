/* title: Objectcache-Object
   Exports <objectcache_oit>: an object which exports interface <objectcache_it>.
   ...
   file: C-kern/api/aspect/interface/objectcache_it.h
    Contains interface definition <Objectcache-Interface>.
*/
#ifndef CKERN_ASPECT_INTERFACE_OBJECTCACHE_OIT_HEADER
#define CKERN_ASPECT_INTERFACE_OBJECTCACHE_OIT_HEADER
