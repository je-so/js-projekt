/* title: SingleLinkedList
   Manages a linear linked list of objects.
   > ---------         ---------
   > | Node1 |         | Node2 |
   > ---------         ---------
   > | *next | ----->  | *next | ------> ...
...
/* struct: slist_t
 * Stores pointers to first/last element of singel linked list. */
struct slist_t {
   /* variable: first
    * Points to first element (header) of list. */
   slist_aspect_t  * first ;
   /* variable: last
...
#define slist_INIT                  { (void*)0, (void*)0 }
 ...
 * node    - The name of the variable of type typeof(listobj->first) which iterates from first to last stored node in list.
 *
 ...
 * */
#define slist_IMPLEMENT(listname, name_nextaspect, cb_t) \
   typedef free_callback_SIGNATURE( freecb ## _ ## listname ## _f, cb_t, typeof(*((listname ## _t*)0)->first) ) ; \
   ...
   static inline typeof(*((listname ## _t*)0)->first) * first ## _ ## listname ( const listname ## _t * list ) __attribute__ ((always_inline)) ; \
   static inline typeof(*((listname ## _t*)0)->first) * last  ## _ ## listname ( const listname ## _t * list ) __attribute__ ((always_inline)) ; \
   static inline typeof(*((listname ## _t*)0)->first) * next  ## _ ## listname ( const typeof(*((listname ## _t*)0)->first) * node ) __attribute__ ((always_inline)) ; \
   static inline int insertfirst ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * new_node ) __attribute__ ((always_inline)) ; \
   static inline int insertlast  ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * new_node ) __attribute__ ((always_inline)) ; \
   static inline int insertafter ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * prev_node, typeof(*((listname ## _t*)0)->first) * new_node ) __attribute__ ((always_inline)) ; \
   static inline int removefirst ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) ** removed_node ) __attribute__ ((always_inline)) ; \
   static inline int removeafter ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * prev_node, typeof(*((listname ## _t*)0)->first)** removed_node ) __attribute__ ((always_inline)) ; \
   ...
   static inline uint32_t next_offset ## _ ## listname(void) { \
      static_assert( offsetof(listname ## _t, first) == 0 , #listname "_t must have same structure as slist_t" ) ; \
      static_assert( offsetof(listname ## _t, last)  == sizeof(void*), #listname "_t must have same structure as slist_t" ) ; \
      static_assert( offsetof( typeof(*((listname ## _t*)0)->first), name_nextaspect) < 65536, "Offset must fit in uint32_t (extend 65536 to pow(2,32) if needed)") ; \
      return (uint32_t) offsetof( typeof(*((listname ## _t*)0)->first), name_nextaspect ) ; \
   } \
   ...
   static inline typeof(*((listname ## _t*)0)->first) * first ## _ ## listname ( const listname ## _t * list ) { \
      return first_slist(list) ; \
   } \
   static inline typeof(*((listname ## _t*)0)->first) * last  ## _ ## listname ( const listname ## _t * list ) { \
      return last_slist(list) ; \
   } \
   static inline typeof(*((listname ## _t*)0)->first) * next  ## _ ## listname ( const typeof(*((listname ## _t*)0)->first) * node ) { \
      return (typeof(*((listname ## _t*)0)->first)*) ((const slist_aspect_t*)(next_offset ## _ ## listname() + (const uint8_t*)node))-> next ; \
   } \
   static inline int insertfirst ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * new_node ) { \
      return insertfirst_generic_slist( (slist_t*)list, (slist_aspect_t*)new_node, next_offset ## _ ## listname()) ; \
   } \
   static inline int insertlast  ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * new_node ) { \
      return insertlast_generic_slist( (slist_t*)list, (slist_aspect_t*)new_node, next_offset ## _ ## listname()) ; \
   } \
   static inline int insertafter ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * prev_node, typeof(*((listname ## _t*)0)->first) * new_node ) { \
      return insertafter_generic_slist( (slist_t*)list, (slist_aspect_t*)prev_node, (slist_aspect_t*)new_node, next_offset ## _ ## listname()) ; \
   } \
   static inline int removefirst ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) ** removed_node ) { \
      return removefirst_generic_slist( (slist_t*)list, (slist_aspect_t**)removed_node, next_offset ## _ ## listname()) ; \
   } \
   static inline int removeafter ## _ ## listname ( listname ## _t * list, typeof(*((listname ## _t*)0)->first) * prev_node, typeof(*((listname ## _t*)0)->first)** removed_node ) { \
 ...
 * node     - The name of the variable of type typeof(listobj->first) which iterates from first to last stored node. */
#define foreach_generic_slist(listname, listobj, node) \
   for( typeof((listobj)->first) node = (listobj)->first; node ; node = next_ ## listname(node))
