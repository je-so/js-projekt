...
*/
#ifndef CKERN_PLATFORM_INDEX_REFBLACKTREE_HEADER
#define CKERN_PLATFORM_INDEX_REFBLACKTREE_HEADER
...
/* function: unittest_platform_index_redblacktree
 * Tests interface of <redblacktree_t>. */
extern int unittest_platform_index_redblacktree(void) ;
#endif
