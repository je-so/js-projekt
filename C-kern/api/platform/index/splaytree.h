/* title: Splaytree-Index
   ...
   file: C-kern/api/platform/index/splaytree.h
    Header file of <Splaytree-Index>.

   file: C-kern/platform/shared/index/splaytree.c
    Implementation file of <Splaytree-Index impl>.
*/
#ifndef CKERN_PLATFORM_INDEX_SPLAYTREE_HEADER
#define CKERN_PLATFORM_INDEX_SPLAYTREE_HEADER
...
/* function: unittest_platform_index_splaytree
 * Tests all functions of <splaytree_t>. */
extern int unittest_platform_index_splaytree(void) ;
#endif
